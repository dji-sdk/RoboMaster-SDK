...
TEST_SUBMODULE(builtin_casters, m) {
    ...
    // Some test characters in utf16 and utf32 encodings.  The last one (the ݐ੠contains a null byte
    char32_t a32 = 0x61 /*a*/, z32 = 0x7a /*z*/, ib32 = 0x203d /*‽*/, cake32 = 0x1f382 /*ߎ⪯,              mathbfA32 = 0x1d400 /*ݐય;
    char16_t b16 = 0x62 /*b*/, z16 = 0x7a,       ib16 = 0x203d,       cake16_1 = 0xd83c, cake16_2 = 0xdf82, mathbfA16_1 = 0xd835, mathbfA16_2 = 0xdc00;
    std::wstring wstr;
    wstr.push_back(0x61); // a
    wstr.push_back(0x2e18); // ⸘
    if (sizeof(wchar_t) == 2) { wstr.push_back(mathbfA16_1); wstr.push_back(mathbfA16_2); } // ݐଠutf16
    else { wstr.push_back((wchar_t) mathbfA32); } // ݐଠutf32
    wstr.push_back(0x7a); // z

    m.def("good_utf8_string", []() { return std::string(u8"Say utf8\u203d \U0001f382 \U0001d400"); }); // Say utf8‽ ߎ⠰퐀
    m.def("good_utf16_string", [=]() { return std::u16string({ b16, ib16, cake16_1, cake16_2, mathbfA16_1, mathbfA16_2, z16 }); }); // b‽ߎⰝ:
    m.def("good_utf32_string", [=]() { return std::u32string({ a32, mathbfA32, cake32, ib32, z32 }); }); // aݐటེ
    m.def("good_wchar_string", [=]() { return wstr; }); // a‽ݐຊ    m.def("bad_utf8_string", []()  { return std::string("abc\xd0" "def"); });
